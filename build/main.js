...
// 1. добавить превьюху картинки туда,г де будет редактирование.
// методы контроллера не должны знать про то, что делается что-то с localStoraage.
// кнтроллер делает минимум телодвижений.
...
app.factory("dataService", function () {
  ...
  return {
    ...
    updateStorage: function updateStorage(obj) {
